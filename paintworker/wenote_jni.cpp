...
JNIEXPORT jint JNICALL native_eraser(JNIEnv * env, jobject thiz, int mode)
{
	LOGD("Flash test : +++++++++++++ native_eraser()");
	paintWorker->SetPenMode(mode);
	paintWorker->SetPenOrEraserFromMode();
...
static JNINativeMethod gMethods[] = {
	...
	{ "native_eraser",      "(I)I",  (void*) native_eraser },
